...
|----|-------|----|------|-------|--------|--------------|-----------------|
| RD-01 | AI-Based Changelog & Release Notes | [RD-01](requirements/RD-01-ai-changelog.md) | [ai-changelog](plans/ai-changelog/00-index.md) | Plan Created | 📋 | 2026-07-12 | Ready for exec_plan (26 tasks) |
